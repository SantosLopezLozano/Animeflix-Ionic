...
export const FIRESTORE_PUBLICANIMES_COLLECTION = 'animeflix-publicAnimes';
export const FIRESTORE_PRIVATEANIMES_COLLECTION = 'animeflix-privateAnimes';
//export const FIRESTORE_ASSIGNMENTS_COLLECTION = 'tareando-assignments';
export const FIRESTORE_IMAGES_COLLECTION = 'animeflix-images';
export const FIRESTORAGE_PREFIX_PATH = 'animeflix-images';
